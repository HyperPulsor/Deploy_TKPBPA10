...
from forum.views import add_forum_flutter, add_reply_flutter, show_json_flutter, show_json_reply_flutter
...
urlpatterns = [
    ...
    path('flutter_reply/json/<forum_id>/', show_json_reply_flutter, name='show_json_reply_flutter'),
]